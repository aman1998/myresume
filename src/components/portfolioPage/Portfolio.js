...
function Portfolio () {
    const portfolio = [
        ...
        {type: 'React', title: 'Resume-Creator', descr: 'Генератор резюме', link: 'https://github.com/aman1998/Resume-Generator', deploy: 'https://murmuring-brushlands-47558.herokuapp.com/', img: resumeImg},
